        ...
        <div>
          ...
          <div>
            <p>
              ...
              Academy of Code as a recipient of the NYC Tech Talent Pipeline's
              Web Development Fellowship, completing their Software Engineering
              Immersive program. My passion for creativity and for meaningful
              and transformative connections first led me to music, and in
              college I built a few simple websites for fun -- but I never
              thought I'd swap my career for my hobby, or find it so rewarding!
              Programming gives me the same opportunities through a different
              medium, and I couldn't love it more. As a full-stack developer, I
              speak JavaScript, use a PERN (PostgreSQL, Express, React, Node)
              stack, and am always eager to learn anything and everything. The
              web is my oyster!
              <br />
              <br />
              While there's so, <em>so</em> much more I plan to do with this
              site, it was important to me that as I learn new skills, I can
