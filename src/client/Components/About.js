    ...
    <div className="component-wrapper">
      ...
      <div className="content-wrapper">
        ...
        <p>
          ...
          based in New York City. {timeAdjust()} I attended Fullstack Academy of
          Code as a recipient of the NYC Tech Talent Pipeline's Web Development
          Fellowship, completing their Software Engineering Immersive program.
          My passion for creativity and for meaningful and transformative
          connections first led me to music, and in college I built a few simple
          websites for fun -- but I never thought I'd swap my career for my
          hobby, or find it so rewarding! Programming gives me the same
        ...
        <p>
          ...
          it was important to me that as I learn new skills, I can demo them as
          new features! In the meantime, please click the navbar buttons to
