  ...
  return (
    <div className="content-wrapper">
      ...
      <p>
        ...
        in New York City. {timeAdjust()} I attended Fullstack Academy of Code as
        a recipient of the NYC Tech Talent Pipeline's Web Development
        Fellowship, completing their Software Engineering Immersive program. My
        passion for creativity and for meaningful and transformative connections
        first led me to music, and in college I built a few simple websites for
        fun -- but I never thought I'd swap my career for my hobby, or find it
        so rewarding! Programming gives me the same opportunities through a
        different medium, and I couldn't love it more. As a full-stack
        developer, I speak JavaScript, use a PERN (PostgreSQL, Express, React,
        Node) stack, and am always eager to learn anything and everything. The
        web is my oyster!
      </p>
      <li>
      ...
      <p>
        ...
        making this world a more inclusive and supportive place, and while it's
        going to be a long time coming, that future can only be secured by the
        work we do today.
      </p>
      ...
      <p>
        It bears repeating, so, look: you're going to slip up and use the wrong
        pronouns. Mistakes happen all the time. Just say whatever it was again
        with the right pronoun and move on -- I'm <em>way</em> more interested
        in what you were actually trying to say!
      </p>
